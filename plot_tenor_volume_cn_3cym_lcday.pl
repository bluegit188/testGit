...
my $DEBUG=0;
 ...
 ($#ARGV+2)==5  || die
"Usage: plot_tenor_volume_cn_3cym_lcday.pl SYM 2021K 2021M 2021M
       Plot volumes for specified tenor file, based on lc daily data.
...
my $file1="/home/jgeng/RawData/lcdaily/Tenors/$sym/${sym}_${ym1}.txt";
my $file2="/home/jgeng/RawData/lcdaily/Tenors/$sym/${sym}_${ym2}.txt";
my $file3="/home/jgeng/RawData/lcdaily/Tenors/$sym/${sym}_${ym3}.txt";


# get the data
    my $cmd="
cat $file1 |mygetcols.pl 1 8 > /tmp/vol.txt.1
datesXmgr.pl /tmp/vol.txt.1  1|fgrep -v DATE|mygetcols.pl 1 3 > /tmp/forplot_vol.txt.1
cat $file2 |mygetcols.pl 1 8 > /tmp/vol.txt.2
datesXmgr.pl /tmp/vol.txt.2  1|fgrep -v DATE|mygetcols.pl 1 3 > /tmp/forplot_vol.txt.2
cat $file3 |mygetcols.pl 1 8 > /tmp/vol.txt.3
