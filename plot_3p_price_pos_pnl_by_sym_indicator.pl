...
( ($#ARGV+2)==6  || ($#ARGV+2)==7) || die
"Usage: plot_3p_price_pos_pnl_by_sym_indicator.pl startDate endDate SYM indName fmin:fmax [opt: isOpen=1/0]
...
# get the data
    my $cmd="
#pnl
check_cumPnl_prod_by_date_range_sym_indName_multi_demean.pl $startDate $endDate  $fminmaxStr 0 $indName $sym
